...
// Create TikTok icon as a Lucide-compatible component
const TikTokIcon = forwardRef<SVGSVGElement, LucideProps>((props, ref) => {
...
// Map of custom icon SVG paths
const iconPaths: Record<CustomIconName, React.ReactElement> = {
  linkedin: (
...
export function CustomIcon({
  ...
  if (size === "sm") sizeValue = 22;
  else if (size === "lg") sizeValue = 28;
  else sizeValue = size;
